...
public class FrostedSidebar: UIViewController {
    ...
    public func showInViewController(viewController: UIViewController, animated: Bool){
        ...
        if animated{
            UIView.animateWithDuration(NSTimeInterval(animationDuration), delay: 0, options: UIViewAnimationOptions.BeginFromCurrentState, animations: animations, completion: completion)
        } else{
            animations()
            completion(true)
        }
